...
public class PersonService implements PersonServiceInterface{
    ...
    public boolean isValid(PersonaDTOinput personaDTOinput) throws Exception {
        if(personaDTOinput.name() == null ){throw new UnprocesableException("El campo name está vacío.");}
        if(personaDTOinput.name().length()<5){throw new UnprocesableException("El campo name tiene menos de 5 carácteres.");}
        if(personaDTOinput.usuario() == null){throw new UnprocesableException("El campo usuario está vacío.");}
        if(personaDTOinput.password() == null){throw new UnprocesableException("El campo password está vacío.");}
        if(personaDTOinput.surname() == null){throw new UnprocesableException("El campo surname está vacío.");}
        if(personaDTOinput.company_email() == null){throw new UnprocesableException("El campo company_email está vacío.");}
        if(personaDTOinput.personal_email() == null){throw new UnprocesableException("El campo personal_email está vacío.");}
        if(personaDTOinput.city() == null){throw new UnprocesableException("El campo city está vacío.");}
        if(personaDTOinput.created_date() == null){throw new UnprocesableException("El campo created_date está vacío.");}
        return true;
    }
